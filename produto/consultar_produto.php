        ...
        <div class="container-fluid" style="min-height: 100vh;">
          <div class="row">
            ...
            <div class="input-field col m2 s5 hide" id="quantidade">
              <input placeholder="Quantidade" id="quantidade_123" name="pesq_nome" type="text">
            </div>

            <div class="input-field col m2 s5 hide" id="valor">
              <input placeholder="Valor" id="valor_123" name="pesq_nome" type="text">
            </div>

            <div class="input-field col m2 s5 hide" id="cfop">
              <input placeholder="CFOP" id="cfop_123" name="pesq_nome" type="text">
            </div>
  ...
  $(document).ready(function(){
    ...
    $('#pesquisar').click(function(e) {
      ...
      if (tipo == 0){
        ...
        var pesq = $('#quantidade_123').val();
        window.location = "consultar_produto_resultado.php?pesq="+pesq+"&tipo="+tipo;
      }else if(tipo == 2){
        var pesq = $('#tipo_pesq').val();
        window.location = "consultar_produto_resultado.php?pesq="+pesq+"&tipo="+tipo;
      }else if(tipo==3){
        var pesq = $('#valor_123').val();
        window.location = "consultar_produto_resultado.php?pesq="+pesq+"&tipo="+tipo;
      }else if(tipo == 4){
        var pesq = $('#fornecedor_pesq').val();
        window.location = "consultar_produto_resultado.php?pesq="+pesq+"&tipo="+tipo;
      }else if(tipo == 5){
       var pesq = $('#cfop_123').val();
       window.location = "consultar_produto_resultado.php?pesq="+pesq+"&tipo="+tipo;
     }
