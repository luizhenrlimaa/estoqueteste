      ...
      <nav style="background:#708090;">
        ...
        <div class="container-fluid" style="min-height: 100vh;">
          ...
          if(empty($info)){
            ...
            <ul class="pagination">
              <li><a href="consultar_contato_resultado.php?pagina=0"><i class="material-icons">chevron_left</i></a></li>
                ...
                for($i = $inicio; $i <= $fim; $i++){
                  ...
                  if($i == $pagina){ ?>
                    <li><a style="text-transform: uppercase;font-weight: 700; background: #3574B9; color: white;" 
                      href="consultar_contato_resultado.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
                    <?php }else { ?>
                      <li><a style="text-transform: uppercase;font-weight: 700; color: #3574B9;" href="consultar_contato_resultado.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
                      <?php 
                    }
                  } if($pagina < $num_paginas-$lim_links-1){echo "<li style='text-transform: uppercase;font-weight: 700; color: #222; font-size: 1.2em;'>. . .</li>";}
                }
                ?>
                <li class="waves-effect"><a href="consultar_contato_resultado.php?pagina=<?php echo $num_paginas-1 ?>"><i class="material-icons">chevron_right</i></a></li>
              </ul>
            <?php } ?>
          </div>
